...
class AlchemyTestPlusAssertionsTest: XCTestCase {
    ...
    func testDoubleAssertEqualsWithMarginOfError() {
        assertEquals(0.5, 0.6, marginOfError: 0.15)
        assertEquals(0.51, 0.65, marginOfError: 0.2)
        assertEquals(12.3, 12.35, marginOfError: 0.1)
        assertEquals(543.21, 541.01, marginOfError: 4.0)
    }
    ...
    func testDateAssertEqualsWithMarginOfError() {
        (1...testIterations).forEach { i in
            ...
            assertEquals(firstDate, secondDate, marginOfError: 2.0)
        }
    }

    func testCGFloatAssertEqualsWithMarginOfError() {
        assertEquals(CGFloat(0.5), CGFloat(0.6), marginOfError: CGFloat(0.15))
        assertEquals(CGFloat(0.51), CGFloat(0.65), marginOfError: CGFloat(0.2))
        assertEquals(CGFloat(12.3), CGFloat(12.35), marginOfError: CGFloat(0.1))
        assertEquals(CGFloat(543.21), CGFloat(541.01), marginOfError: CGFloat(4.0))
    }

    func testDecimalAssertEqualsWithMarginOfError() {
        assertEquals(Decimal(0.5), Decimal(0.6), marginOfError: Decimal(0.15))
        assertEquals(Decimal(0.51), Decimal(0.65), marginOfError: Decimal(0.2))
